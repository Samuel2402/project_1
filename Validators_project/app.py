...
class UserCheck:
    ...
    def __call__(self, form, field):
        1# Here we define the method that is ran when the class is called. If the data in our field is in the list of words then raise a ValidationError object with a message.
